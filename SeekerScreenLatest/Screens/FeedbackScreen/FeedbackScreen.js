...
const ArrivedScreen: () => React$Node = ({navigation}) => {
  return (
    <>
    <View style={{
      flex: 0.8,
    ...
    <View style={{flex:3, justifyContent: 'center', alignItems: 'center', backgroundColor: '#fdfdfd'}}>
        ...
        <View style={{flexDirection:'row' ,justifyContent: 'center', alignItems: 'center', backgroundColor: '#fdfdfd', height:150}}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('SeekerStart')} >
              <Text style={styles.buttonText}
              onPress={() => navigation.navigate('SeekerStart')}>DONE</Text>
            </TouchableOpacity>
    </View>
